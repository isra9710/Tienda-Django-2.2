...
def default(request, pk):
    ...
    if request.user.id != shipping_address.user_id:#Sólo el usuario al que le pertenece puede hacer default a una dirección
        return redirect('carts:cart')#De otro modo es redirigido
    #Antes de actualizar obtener la antigua dirección principal
